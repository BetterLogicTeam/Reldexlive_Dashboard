                    ...
                    <div className="modal-content">
                      <div className="modal-header">
                        <div className="avlbal">
                          <h2 id="exampleModal3Label2" style={{ color: "#fff" }}>
                            Activation
                          </h2>
                          <h5 className="modal-title" id="exampleModal3Label2">
                            Available Token Balance :<span id="tokenbalance">0</span>
                            <span> RDX</span>
                          </h5>
                          <h5 className="modal-title" id="exampleModal3Label2">
                            Available BUSD Balance :<span id="BUSDbalance">0</span>
                            <span> BUSD</span>
                          </h5>
                          <h5 className="modal-title" id="exampleModal3Label2">
                          ...
                          <h5 className="modal-title" id="exampleModal3Label2">
                            Live Rate :
                            <span id="txtchangevalue" style={{ color: "#fff" }} />
                          </h5>
                        </div>
                      </div>
                            ...
                            <div className="row joinbtn justify-content-center">
                              <div className="col-md-8">
                                <div className="d-flex resetBtn">
                                  <div>
                                    <button className="button" onclick="reset2()">
                                      Reset
                                    </button>
                                  </div>
                                  <div>
