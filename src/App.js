    ...
    <div className="App ApiA" ng-app="MyApp">
      <Routes>
        ...
        <Route exact path="/dashboard" element={<Landing />}>
          ...
          <Route
            path="/dashboard/Activation_history"
            element={<Activation_history />}
          />
          <Route
            path="/dashboard/BuyOnline_Fund"
            element={<BuyOnline_Fund />}
          />
          <Route
          ...
          <Route
            path="/dashboard/RoiLevelIncome"
            element={<RoiLevelIncome />}
          />
          ...
          <Route
            path="/dashboard/DirectlegBussiness"
            element={<DirectlegBussiness />}
          />
          <Route path="/dashboard/Bonanza" element={<Bonanza />} />
          <Route
            path="/dashboard/Withdrawal_form"
            element={<Withdrawal_form />}
          />
          <Route
          ...
          />
          <Route
            path="/dashboard/Ecurrency_Details"
            element={<Ecurrency_Details />}
          />
          <Route
