...
export default function DirectlegBussiness() {
    var [reward_income, set_reward_income] = new useState({
        cols: [
          { Header: "Sr.No.", accessor: "sr" },
          { Header: "User ID", accessor: "userid" },
            { Header: "User Name", accessor: "userid2" },
          {Header:'				Self Investment',accessor:'statuss'},
          {Header:'			Team Business',accessor:'Date'},
          ...
          <div className="card">
            <div className="card-header d-flex justify-content-between">
              <div className="header-title">
                <h4 className="card-title">Direct Leg Business</h4>
              </div>
            </div>
